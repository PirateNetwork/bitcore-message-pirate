...
bitcore-message-pirate adds support for verifying and signing pirate messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-pirate
```

```sh
bower install bitcore-message-pirate
```
